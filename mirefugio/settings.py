...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-g=+tt#_+d$vjo6rmelsu&&$&g)n7uf4dnxj_@!2zr_arof=1$3")
...
# PostgreSQL (usa DATABASE_URL del .env)
DATABASES = {"default": env.db(default="postgres://usuario:pass@localhost:5432/mirefugio")}
